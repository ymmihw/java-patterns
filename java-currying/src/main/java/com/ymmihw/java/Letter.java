...
public class Letter {
  ...
  Letter(String returningAddress, String insideAddress, LocalDate dateOfLetter, String salutation,
      String body, String closing) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(returningAddress, letter.returningAddress)
        ...
        && Objects.equals(salutation, letter.salutation) && Objects.equals(body, letter.body)
  ...
  public String toString() {
    return "Letter{" + "returningAddress='" + returningAddress + '\'' + ", insideAddress='"
        + insideAddress + '\'' + ", dateOfLetter=" + dateOfLetter + ", salutation='" + salutation
        + '\'' + ", body='" + body + '\'' + ", closing='" + closing + '\'' + '}';
  }
  ...
  static Function<String, Function<String, Function<LocalDate, Function<String, Function<String, Function<String, Letter>>>>>> LETTER_CREATOR = //
      returnAddress -> closing -> dateOfLetter -> insideAddress -> salutation -> body -> new Letter(
          returnAddress, insideAddress, dateOfLetter, salutation, body, closing);

  static AddReturnAddress builder() {
    return returnAddress -> closing -> dateOfLetter -> insideAddress -> salutation -> body -> new Letter(
        returnAddress, insideAddress, dateOfLetter, salutation, body, closing);
  }
